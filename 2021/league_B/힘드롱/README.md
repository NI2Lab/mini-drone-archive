# [MINI DRONE 대회](http://mini-drone.co.kr/notice)
...
# I. 대회 진행 전략
## __1. Python 설치 및 VSCode 개발 환경 구축__
* <img src="https://user-images.githubusercontent.com/82248453/125612432-5fc3402e-1fa4-4966-ba2f-65a92fd3aa5b.png" width="20" height="20"> Python 설치:
<https://www.python.org/downloads/></br>
* <img src="https://user-images.githubusercontent.com/82248453/125473710-f3ad6de2-7c29-4670-8808-577a3ed86872.png" width="20" height="20"> VSCode 설치: <https://code.visualstudio.com></br>
* <img src="https://user-images.githubusercontent.com/82248453/125612432-5fc3402e-1fa4-4966-ba2f-65a92fd3aa5b.png" width="20" height="20"> Python VSCode Extension 설치: <https://marketplace.visualstudio.com/items?itemName=ms-python.python></br>
...
# II. 알고리즘 
<img src="https://user-images.githubusercontent.com/82248453/125609037-c0ed67d0-ef91-45c4-8cc5-6942ed9ce419.png" width="500" height="600">
</br>
</br>
</br>
...
Threshold 값 적용된 이미지에 MedianBlur로 노이즈 제거</br></br></br>

### 2. __드론 제어__

a) Blue 픽셀 개수에 따라 모드 분류
```python
mode = {1:[range(100, 30000), range(30000, 100000), range(100000, 150000), 150000], 
        ...
        3:[range(100, 50000), range(50000, 140000), range(140000, 200000), 200000]}
```
</br></br>
b) 직선 이동
...
def moveLarge(drone, BlueSum):
    ...
    drone.sendControlPosition16(11, 0, 0, 8, 0, 0)
    sleep(4)
...
def moveSoso(drone, BlueSum):
    ...
    drone.sendControlPosition16(8, 0, 0, 7, 0, 0)
    sleep(3)
